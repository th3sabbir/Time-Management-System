...
<div class="page-heading">
    <div>
        <h4><i class="fa-solid fa-plus-circle me-2 text-primary"></i>New Project</h4>
        <p class="text-muted mb-0" style="font-size:13px;"><a href="{{ route('projects.index') }}" class="text-decoration-none text-muted">Projects</a> &rsaquo; Create</p>
    </div>
</div>
...
<div class="card" style="max-width:560px;">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            {!! Form::text('name', old('name'), ['class'=>'form-control','placeholder'=>'Enter project name']) !!}
