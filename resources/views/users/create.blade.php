...
<div class="page-heading">
  <div>
    <h4><i class="fa-solid fa-user-plus me-2 text-primary"></i>New User</h4>
    <p class="text-muted mb-0" style="font-size:13px;"><a href="{{ route('users.index') }}" class="text-decoration-none text-muted">Users</a> &rsaquo; Create</p>
  </div>
</div>
...
<div class="card" style="max-width:600px;">
  ...
  <div class="card-body">
    ...
    <div class="mb-3">
      ...
      {!! Form::email('email', old('email'), ['class' => 'form-control', 'placeholder' => 'user@company.com']) !!}
      @error('email')<div class="text-danger mt-1" style="font-size:12px;">{{ $message }}</div>@enderror
    </div>
    <div class="mb-3">
      {!! Form::label('password', 'Password *', ['class' => 'form-label']) !!}
      {!! Form::password('password', ['class' => 'form-control', 'placeholder' => 'Min 8 characters']) !!}
    ...
    <div class="mb-3">
      ...
      {!! Form::select('role_id', $roles, old('role_id'), ['class' => 'form-select']) !!}
