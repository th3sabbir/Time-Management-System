...
<div class="page-heading">
    <div>
        <h4><i class="fa-solid fa-plus-circle me-2 text-primary"></i>Log Time Entry</h4>
        <p class="text-muted mb-0" style="font-size:13px;"><a href="{{ route('time_entries.index') }}" class="text-decoration-none text-muted">Time Entries</a> &rsaquo; Create</p>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    {!! Form::select('project_id', $projects, old('project_id'), ['class'=>'form-select']) !!}
                ...
                <div class="mb-3">
                    ...
                    {!! Form::select('work_type_id', $work_types, old('work_type_id'), ['class'=>'form-select']) !!}
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    {!! Form::text('start_time', old('start_time'), ['class'=>'form-control flatpickr-dt','placeholder'=>'Select start date & time']) !!}
                ...
                <div class="mb-3">
                    ...
                    {!! Form::text('end_time', old('end_time'), ['class'=>'form-control flatpickr-dt','placeholder'=>'Select end date & time']) !!}
